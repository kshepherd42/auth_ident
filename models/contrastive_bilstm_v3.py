...
class ContrastiveBilstmV3():
    ...
    def create_model(self, params, index, logger):
        ...
        lstm1 = Bidirectional(LSTM(128, name='lstm1', return_sequences=True), merge_mode="concat")
        lstm2 = Bidirectional(LSTM(128, name='lstm2'), merge_mode="concat", name='output_embedding')
        dense1 = Dense(128, name='dense1', activation='relu', use_bias=True)
        dense2 = Dense(128, name='dense2', use_bias=False)
        ...
        dense1_left = dense1(lstm2_left)
        dense1_right = dense1(lstm2_right)

        dense2_left = dense2(dense1_left)
        dense2_right = dense2(dense1_right)
        
        lstm_concat = Concatenate(axis=0)([dense2_left, dense2_right])
